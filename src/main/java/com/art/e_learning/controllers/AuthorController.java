...
public class AuthorController {
    ...
    public ResponseEntity<Map<String, Object>> getAll(){
        ...
        response.put("Authors", this.authorService.getAll());
    ...
    public ResponseEntity<Map<String, Object>> getByName(@PathVariable String firstName){
        Author findAuthor = this.authorService.getByName(firstName);
        Map<String, Object> response = new HashMap<>();
        HttpStatus status;
    ...
    @PostMapping
    public ResponseEntity<Map<String, Object>> create(@Valid @RequestBody Author author){
        ...
        if(newAuthor.getEmail().equals("repeated email")){
    ...
    public ResponseEntity<Map<String, Object>> deleteById(@PathVariable Integer id){
        boolean isDeleted = this.authorService.delete(id);
        Map<String, Object> response = new HashMap<>();
        HttpStatus status;
